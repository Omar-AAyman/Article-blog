...
<body class="font-sans antialiased ">
    ...
    <div class="max-w-md mx-auto bg-slate-100 rounded-lg p-4 mt-12">
        <form action="{{ route('articles.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-6">
                <label for="message" class="block mb-2 text-l font-medium text-gray-900 ">Article Title</label>
            ...
            <div class="mb-6">
                ...
                <textarea id="message" rows="4" name="articleContent"
                    ...
                    placeholder="Write your article here.. But be creative when writing!">{{ old('articleContent') }}</textarea>
